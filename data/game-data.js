...
(() => {
  const formations = {
    taiyi_zhenyao_array: {
      ...
      rarity: "初始",
      role: "通用压制 / 阵前伤害",
      isCoreFormation: false,
      formationTier: "legacy",
      displayInLoadout: false,
      combatIdentity: "旧版通用镇妖阵",
      mechanicVerb: "镇妖",
      passiveText: "旧版通用镇妖阵，当前不作为核心阵法重点展示。",
      activeSkill: {
        name: "太乙镇妖",
        type: "legacy_control",
        description: "旧版通用镇妖阵诀，保留为后续教程或剧情阵法预留。",
      },
      designNote: "旧版通用镇妖阵，定位过于中庸，当前从核心阵法中移出，保留为后续剧情或教程阵法。",
      ...
      effectText: "旧版通用镇妖阵，当前不作为核心阵法重点展示。",
      description: "旧版通用镇妖阵，保留为后续剧情或教程阵法。",
      portrait: "assets/images/formations/portrait/taiyi_zhenyao_array.webp",
      thumb: "assets/images/formations/thumb/taiyi_zhenyao_array.webp",
    },
    qinglian_huiyuan_array: {
      ...
      rarity: "初始",
      role: "防守续航 / 救场护阵",
      isCoreFormation: true,
      formationTier: "core_defense",
      displayInLoadout: true,
      combatIdentity: "防守续航 / 救场护阵",
      mechanicVerb: "护持",
      passiveText: "每隔一段时间回复护山阵眼生命。",
      activeSkill: {
        name: "山河护命",
        type: "defense_control",
        description: "召出山岳虚影压向战场，击退所有敌人，并为阵眼生成护盾。",
      },
      triggerType: "interval",
      triggerInterval: 6.0,
      heal: 14,
      ...
      effectText: "每隔一段时间回复阵眼生命，低血时回复量提升；后续主动阵诀将提供击退与护盾。",
      description: "防守续航与救场护阵兼具的核心阵法。",
      portrait: "assets/images/formations/portrait/qinglian_huiyuan_array.webp",
      thumb: "assets/images/formations/thumb/qinglian_huiyuan_array.webp",
    },
    xuanbing_chiyao_array: {
      ...
      role: "减速控线",
      isCoreFormation: true,
      formationTier: "core_control",
      displayInLoadout: true,
      combatIdentity: "推进减速 / 控场",
      mechanicVerb: "迟滞",
      passiveText: "周期凝结玄冰阵纹，迟滞妖潮推进。",
      activeSkill: {
        name: "玄冰封界",
        type: "aoe_slow_freeze",
        description: "全屏或大范围强减速，部分敌人短暂冻结，为门人与法宝创造爆发窗口。",
      },
      triggerType: "interval",
      triggerInterval: 5.5,
      areaRule: "lower_lane",
      ...
      portrait: "assets/images/formations/portrait/xuanbing_chiyao_array.webp",
      thumb: "assets/images/formations/thumb/xuanbing_chiyao_array.webp",
    },
    lihuo_fenyao_array: {
      ...
      role: "范围灼烧 / 清小怪",
      isCoreFormation: true,
      formationTier: "core_aoe",
      displayInLoadout: true,
      combatIdentity: "密集妖潮惩罚",
      mechanicVerb: "引燃",
      passiveText: "周期引燃妖物密集区域，敌人越密集收益越高。",
      activeSkill: {
        name: "离火焚天",
        type: "aoe_burn",
        description: "在战场多处降下离火，造成大范围伤害并留下持续火区。",
      },
      triggerType: "interval",
      triggerInterval: 5.0,
      targetRule: "densest_cluster",
      ...
      portrait: "assets/images/formations/portrait/lihuo_fenyao_array.webp",
      thumb: "assets/images/formations/thumb/lihuo_fenyao_array.webp",
    },
    leigang_zhuxie_array: {
      ...
      role: "群体雷击 / 短控爆发",
      isCoreFormation: true,
      formationTier: "core_burst_control",
      displayInLoadout: true,
      combatIdentity: "群体雷击 / 短控爆发",
      mechanicVerb: "诛邪",
      passiveText: "周期召落雷罡，对多个敌人造成雷击，并有概率短暂眩晕。",
      activeSkill: {
        name: "九霄雷罚",
        type: "aoe_stun",
        description: "对全屏或大范围敌人进行多轮雷击，造成群体伤害并施加短暂眩晕；精英和 Boss 可受到额外雷罚伤害。",
      },
      triggerType: "interval",
      triggerInterval: 5.8,
      ...
      effectText: "周期召落雷罡，对多个敌人造成雷击，并预留短暂眩晕方向。",
      description: "群体雷击与短控爆发兼具，适合压制密集妖潮与精英目标。",
      portrait: "assets/images/formations/portrait/leigang_zhuxie_array.webp",
      thumb: "assets/images/formations/thumb/leigang_zhuxie_array.webp",
    },
    shanhe_guyuan_array: {
      ...
      role: "阵眼减伤 / 阵前压制",
      isCoreFormation: false,
      formationTier: "merged",
      displayInLoadout: false,
      mergedInto: "qinglian_huiyuan_array",
      combatIdentity: "已并入青莲山河阵",
      mechanicVerb: "固元",
      passiveText: "已并入青莲山河阵，防御与护盾能力作为青莲山河阵主动阵诀的一部分。",
      activeSkill: {
        name: "山河护命",
        type: "merged_defense_control",
        description: "已并入青莲山河阵，后续作为青莲山河阵主动阵诀的一部分呈现。",
      },
      designNote: "已并入青莲山河阵，防御与护盾能力作为青莲山河阵主动阵诀的一部分。",
      ...
      effectText: "已并入青莲山河阵，防御与护盾能力作为青莲山河阵主动阵诀的一部分。",
      description: "归档阵法，保留旧数据以避免引用报错。",
      portrait: "assets/images/formations/portrait/shanhe_guyuan_array.webp",
      thumb: "assets/images/formations/thumb/shanhe_guyuan_array.webp",
    },
    xingdou_juling_array: {
      ...
      role: "灵气获取 / 成长加速",
      isCoreFormation: true,
      formationTier: "late_growth",
      displayInLoadout: true,
      unlockHint: "后续章节开放",
      combatIdentity: "灵气成长 / 快速成型",
      mechanicVerb: "聚灵",
      passiveText: "提高灵气获取效率。",
      activeSkill: {
        name: "周天星落",
        type: "aoe_growth",
        description: "召唤星陨轰炸战场，同时获得额外灵气；若击杀敌人，可额外推进机缘进度。",
      },
      ...
      portrait: "assets/images/formations/portrait/xingdou_juling_array.webp",
      thumb: "assets/images/formations/thumb/xingdou_juling_array.webp",
    },
    wanjian_hushan_array: {
      ...
      role: "阵眼反击 / 飞剑支援",
      isCoreFormation: true,
      formationTier: "starter",
      displayInLoadout: true,
      combatIdentity: "阵前剑气拦截",
      mechanicVerb: "拦截",
      passiveText: "周期释放阵前剑气，拦截靠近阵眼的妖物。",
      activeSkill: {
        name: "万剑归山",
        type: "screen_sword_rain",
        description: "屏幕左右两侧与上方同时飞入大量飞剑，形成交叉剑雨，对战场敌人造成多段伤害。",
      },
      triggerType: "interval",
      triggerInterval: 4.8,
      ...
      portrait: "assets/images/formations/portrait/wanjian_hushan_array.webp",
      thumb: "assets/images/formations/thumb/wanjian_hushan_array.webp",
    },
  };
  window.GAME_DATA.formations = formations;
  window.GAME_DATA.initial.formation = "wanjian_hushan_array";
...
(() => {
  const enemies = {
    ...
    gloom_arrow_hound: {
      ...
      rangedAttackInterval: 1.9,
      rangedStopOffset: 200,
    ...
    black_gate_guardian: {
      ...
      damageReductionDuringArmor: 0.3,
      supportRadius: 135,
      hasteMultiplier: 0.18,
      hasteDuration: 2.0,
      abilities: [
        {
          id: "black_gate_demon_armor",
          type: "demon_armor",
          cooldown: 6.5,
          duration: 2.5,
          params: { damageReduction: 0.3 },
        ...
        {
          id: "black_gate_battle_roar",
          type: "battle_roar",
          cooldown: 6.5,
          duration: 2.0,
          params: { hasteMultiplier: 0.18 },
        },
      ],
  ...
  const waveTemplates = {
    1: {
      goal: "赤鬃初潮",
      segments: [
        { enemyId: "redmane_fiend", count: 9, startDelay: 0, spawnInterval: 0.92 },
      ],
      lingqiScale: 72,
    ...
    2: {
      ...
      segments: [
        ...
        { enemyId: "shadow_hound", count: 3, startDelay: 2.2, spawnInterval: 1.05 },
      ],
      lingqiScale: 91,
    ...
    3: {
      ...
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.95 },
        { enemyId: "ironhide_xiao", count: 2, startDelay: 3.0, spawnInterval: 2.0 },
      ],
      lingqiScale: 92,
    ...
    4: {
      ...
      segments: [
        ...
        { enemyId: "shadow_hound", count: 5, startDelay: 1.0, spawnInterval: 0.95 },
        { enemyId: "rending_claw", count: 3, startDelay: 2.7, spawnInterval: 1.35 },
      ],
      lingqiScale: 111,
    ...
    5: {
      ...
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.95 },
        { enemyId: "ironhide_xiao", count: 2, startDelay: 2.6, spawnInterval: 2.0 },
        { enemyId: "redmane_demon_general", count: 1, startDelay: 5.4, spawnInterval: 1.0 },
      ],
      lingqiScale: 135,
    ...
    6: {
      goal: "幽符助妖",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.9 },
        { enemyId: "shadow_hound", count: 3, startDelay: 1.8, spawnInterval: 1.05 },
        { enemyId: "dark_talisman_shaman", count: 1, startDelay: 4.3, spawnInterval: 3.0 },
      ],
      lingqiScale: 123,
    ...
    7: {
      goal: "腐瘴留形",
      segments: [
        { enemyId: "redmane_fiend", count: 6, startDelay: 0, spawnInterval: 0.9 },
        { enemyId: "miasma_mirage", count: 2, startDelay: 2.0, spawnInterval: 1.6 },
        { enemyId: "shadow_hound", count: 3, startDelay: 3.8, spawnInterval: 1.0 },
        { enemyId: "ironhide_xiao", count: 1, startDelay: 5.4, spawnInterval: 2.0 },
      ],
      lingqiScale: 129,
    ...
    8: {
      goal: "噬阵初现",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.82 },
        { enemyId: "ironhide_xiao", count: 2, startDelay: 1.7, spawnInterval: 1.8 },
        { enemyId: "gloom_arrow_hound", count: 3, startDelay: 3.6, spawnInterval: 1.8 },
      ],
      lingqiScale: 196,
    ...
    9: {
      goal: "群妖混潮",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.8 },
        { enemyId: "rending_claw", count: 3, startDelay: 1.6, spawnInterval: 1.2 },
        { enemyId: "miasma_mirage", count: 2, startDelay: 2.5, spawnInterval: 1.55 },
        { enemyId: "gloom_arrow_hound", count: 3, startDelay: 4.0, spawnInterval: 1.7 },
      ],
      lingqiScale: 220,
    ...
    10: {
      ...
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.8 },
        { enemyId: "redmane_demon_general", count: 1, startDelay: 1.6, spawnInterval: 1.0 },
        { enemyId: "ironhide_xiao", count: 3, startDelay: 2.8, spawnInterval: 1.75 },
        { enemyId: "array_devouring_moth", count: 2, startDelay: 4.6, spawnInterval: 2.1 },
        { enemyId: "dark_talisman_shaman", count: 1, startDelay: 6.4, spawnInterval: 2.8 },
      ],
      lingqiScale: 231,
    ...
    11: {
      goal: "骨符幽箭",
      segments: [
        { enemyId: "redmane_fiend", count: 10, startDelay: 0, spawnInterval: 0.78 },
        { enemyId: "shadow_hound", count: 5, startDelay: 1.5, spawnInterval: 0.9 },
        { enemyId: "gloom_arrow_hound", count: 3, startDelay: 3.2, spawnInterval: 1.65 },
        { enemyId: "bone_talisman_witch", count: 1, startDelay: 5.2, spawnInterval: 2.8 },
      ],
      lingqiScale: 270,
      settlementLingstone: 70,
    },
    12: {
      goal: "铁甲噬阵",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.78 },
        { enemyId: "ironhide_xiao", count: 4, startDelay: 1.2, spawnInterval: 1.75 },
        { enemyId: "array_devouring_moth", count: 2, startDelay: 3.4, spawnInterval: 2.1 },
        { enemyId: "miasma_mirage", count: 3, startDelay: 5.0, spawnInterval: 1.55 },
      ],
      lingqiScale: 283,
      settlementLingstone: 75,
    },
    13: {
      goal: "双巫催潮",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.76 },
        { enemyId: "shadow_hound", count: 6, startDelay: 1.0, spawnInterval: 0.86 },
        { enemyId: "rending_claw", count: 3, startDelay: 2.6, spawnInterval: 1.2 },
        { enemyId: "gloom_arrow_hound", count: 2, startDelay: 3.8, spawnInterval: 1.7 },
        { enemyId: "dark_talisman_shaman", count: 2, startDelay: 4.4, spawnInterval: 2.6 },
      ],
      lingqiScale: 294,
      settlementLingstone: 80,
    },
    14: {
      goal: "远咒压阵",
      segments: [
        { enemyId: "redmane_fiend", count: 8, startDelay: 0, spawnInterval: 0.76 },
        { enemyId: "ironhide_xiao", count: 3, startDelay: 1.5, spawnInterval: 1.75 },
        { enemyId: "gloom_arrow_hound", count: 4, startDelay: 3.2, spawnInterval: 1.55 },
        { enemyId: "array_devouring_moth", count: 1, startDelay: 4.8, spawnInterval: 2.0 },
        { enemyId: "bone_talisman_witch", count: 1, startDelay: 5.8, spawnInterval: 2.8 },
      ],
      lingqiScale: 300,
      settlementLingstone: 85,
    },
    15: {
      goal: "妖将远压",
      segments: [
        { enemyId: "redmane_fiend", count: 10, startDelay: 0, spawnInterval: 0.74 },
        { enemyId: "ironhide_xiao", count: 3, startDelay: 1.6, spawnInterval: 1.75 },
        { enemyId: "gloom_arrow_hound", count: 3, startDelay: 3.2, spawnInterval: 1.55 },
        { enemyId: "black_gate_guardian", count: 1, startDelay: 5.6, spawnInterval: 1.0 },
        { enemyId: "bone_talisman_witch", count: 1, startDelay: 6.0, spawnInterval: 2.8 },
        { enemyId: "array_devouring_moth", count: 2, startDelay: 7.0, spawnInterval: 2.0 },
      ],
      lingqiScale: 410,
      settlementLingstone: 100,
      isBossWave: true,
    },
  };
  ...
  (window.GAME_DATA.waves || []).forEach((wave) => {
    ...
    wave.isBossWave = Boolean(template.isBossWave);
  });
})();
