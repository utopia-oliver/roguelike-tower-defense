  ...
  const waveTemplates = {
    ...
    8: {
      ...
      segments: [
        ...
        { enemyId: "array_devouring_moth", count: 2, startDelay: 4.2, spawnInterval: 2.0 },
      ],
      lingqiScale: 108,
    ...
    9: {
      ...
      segments: [
        ...
        { enemyId: "shadow_hound", count: 3, startDelay: 1.0, spawnInterval: 0.9 },
    ...
    10: {
      ...
      segments: [
        ...
        { enemyId: "dark_talisman_shaman", count: 1, startDelay: 6.0, spawnInterval: 2.8 },
      ],
      lingqiScale: 149,
